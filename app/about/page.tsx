...
const About: React.FC = () => {
  ...
  const stats = [
    {
      icon: Building,
      value: "500+",
      label: language === "ar" ? "عقار متاح" : "Properties Available",
    },
    {
      icon: Users,
      value: "1000+",
  ...
  const team = [
    ...
    },
    {
      ...
      image:
        "https://images.pexels.com/photos/3763188/pexels-photo-3763188.jpeg?auto=compress&cs=tinysrgb&w=300&h=300&fit=crop",
            ...
            <div className="space-y-8">
              {timeline.map((item, index) => (
                <div
                  ...
                  <div className="flex-1 bg-white dark:bg-gray-900 p-6 rounded-lg shadow-lg">
                    <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
                      {item.title}
                    </h3>
                    <p className="text-gray-600 dark:text-gray-300">
