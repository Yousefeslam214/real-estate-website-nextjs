  ...
  const newsItems1 = [
    {
      ...
      excerpt:
        language === "ar"
          ? "الحكومة تعلن عن إطلاق المرحلة الثالثة من مشروع العاصمة الإدارية الجديدة بخطة استثمارية ضخمة..."
          : "Government announces the launch of the third phase of the New Administrative Capital project with massive investment plans...",
      date: "2025-01-15",
      image:
    ...
    },
    {
      ...
      excerpt:
        language === "ar"
          ? "تحديثات جديدة على قوانين تملك الأجانب للعقارات في مصر لتشجيع الاستثمار الأجنبي..."
          : "New updates to foreign property ownership laws in Egypt to encourage foreign investment...",
      date: "2025-01-12",
      image:
    ...
    },
    {
      ...
      excerpt:
        language === "ar"
          ? "إطلاق برنامج جديد للإسكان الاجتماعي يستهدف الشباب والأسر محدودة الدخل..."
          : "Launch of a new social housing program targeting youth and low-income families...",
      date: "2025-01-10",
      image:
