...
const Properties: React.FC = () => {
  ...
  const properties = [
    ...
    {
      id: 2,
      title: language === 'ar' ? 'فيلا حديثة في الشيخ زايد' : 'Modern Villa in Sheikh Zayed',
    ...
    {
      id: 3,
      title: language === 'ar' ? 'مكتب تجاري في وسط البلد' : 'Commercial Office Downtown',
    ...
    {
      id: 5,
      title: language === 'ar' ? 'أرض للبيع في القاهرة الجديدة' : 'Land for Sale in New Cairo',
    ...
    {
      id: 6,
      title: language === 'ar' ? 'مجمع تجاري في مدينة نصر' : 'Commercial Complex in Nasr City',
