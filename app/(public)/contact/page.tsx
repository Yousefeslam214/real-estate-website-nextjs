  ...
  const contactInfo = [
    {
      ...
      content:
        language === "ar"
          ? "وزارة الإسكان، العاصمة الإدارية الجديدة، مصر"
          : "Ministry of Housing, New Administrative Capital, Egypt",
      color: "bg-blue-500",
    },
    {
      icon: Phone,
    ...
    },
    {
      ...
      content: "yousefeslam214@gmail.com",
      color: "bg-purple-500",
    },
    {
      icon: Clock,
  ...
  const departments = [
    {
      ...
      phone: "01005307391",
      email: "yousefeslam214@gmail.com",
      description:
        language === "ar"
          ? "للاستفسار عن العقارات المتاحة والأسعار"
          : "For inquiries about available properties and prices",
    },
    {
      ...
      description:
        language === "ar"
          ? "للدعم الفني وحل المشاكل"
          : "For technical support and problem solving",
    },
    {
      ...
      description:
        language === "ar"
          ? "للاستشارات القانونية والعقود"
          : "For legal consultations and contracts",
    },
  ];
  ...
  const faqItems = [
    {
      question:
        language === "ar"
          ? "كيف يمكنني تسجيل عقار جديد؟"
          : "How can I register a new property?",
      answer:
        language === "ar"
          ? "يمكنك تسجيل عقار جديد من خلال زيارة مكاتبنا أو استخدام المنصة الإلكترونية مع تقديم المستندات المطلوبة."
          : "You can register a new property by visiting our offices or using the electronic platform with the required documents.",
    },
    {
      question:
        language === "ar"
          ? "ما هي الرسوم المطلوبة للتسجيل؟"
          : "What are the required registration fees?",
      answer:
        language === "ar"
          ? "تختلف الرسوم حسب نوع العقار وقيمته. يمكنك الاطلاع على جدول الرسوم المحدث على موقعنا الإلكتروني."
          : "Fees vary according to property type and value. You can check the updated fee schedule on our website.",
    },
    {
      question:
        language === "ar"
          ? "كم يستغرق إجراء التسجيل؟"
          : "How long does the registration process take?",
      answer:
        language === "ar"
          ? "عادة ما يستغرق التسجيل من 7 إلى 14 يوم عمل حسب نوع العقار واكتمال المستندات."
          : "Registration usually takes 7 to 14 business days depending on property type and document completeness.",
    },
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {contactInfo.map((info, index) => {
              ...
              return (
                <div
                  key={index}
                  className="text-center p-6 bg-gray-50 dark:bg-gray-700 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                  <div
                    className={`${info.color} w-16 h-16 rounded-2xl mx-auto mb-4 flex items-center justify-center`}>
