...
const translations = {
  en: {
    ...
    'hero.subtitle': 'Your gateway to government-verified properties and real estate services',
    'hero.search.placeholder': 'Search for properties, locations, or property types...',
    ...
    'properties.subtitle': 'Discover verified government properties across Egypt',
    ...
    'services.registration.desc': 'Official property registration and documentation services',
    'services.valuation': 'Property Valuation',
    'services.valuation.desc': 'Professional property assessment and valuation services',
    'services.licensing': 'Real Estate Licensing',
    'services.licensing.desc': 'Licensing services for real estate professionals',
    'services.consultation': 'Legal Consultation',
    'services.consultation.desc': 'Expert legal advice for real estate transactions',
    
    // About
    'about.title': 'About Egyptian Real Estate Portal',
    'about.description': 'The Egyptian Real Estate Portal is the official government platform dedicated to providing comprehensive real estate services to Egyptian citizens and investors. Our mission is to facilitate transparent, efficient, and secure real estate transactions while ensuring compliance with Egyptian property laws and regulations.',
    
    // News
    'news.title': 'Latest News & Updates',
    'news.subtitle': 'Stay informed about real estate developments and policy changes',
    ...
    // Footer
    'footer.description': 'Official Egyptian Government Real Estate Portal providing comprehensive property services and information.',
  ...
  ar: {
    ...
    'hero.search.placeholder': 'ابحث عن العقارات أو المواقع أو أنواع العقارات...',
    ...
    'about.description': 'البوابة المصرية للعقارات هي المنصة الحكومية الرسمية المخصصة لتقديم خدمات عقارية شاملة للمواطنين المصريين والمستثمرين. مهمتنا هي تسهيل المعاملات العقارية الشفافة والفعالة والآمنة مع ضمان الامتثال لقوانين ولوائح العقارات المصرية.',
    ...
    // Footer
    'footer.description': 'البوابة الرسمية للحكومة المصرية للعقارات التي تقدم خدمات ومعلومات عقارية شاملة.',
